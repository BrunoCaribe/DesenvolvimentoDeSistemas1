 ...
 * @author brcar
 */
public class FimPacie extends javax.swing.JFrame {
  ...
  public void Imprimir(){
    ...
    public FimPacie() {
        ...
        jLabel5.setText(String.valueOf(Pnasci));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FimPacie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
